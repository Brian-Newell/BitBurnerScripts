...
This does NOT require the singularity unlocks as it simply feeds to commands directly to the terminal.  
Due to this nature, this script MUST be left to run without any interruptions and the terminal must be in view at all times.
